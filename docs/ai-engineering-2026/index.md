...
|-------------------|---------------------|------------|-------------|
| **Claude Code & Agentic Workflows** | Anthropic | Official terminal agent walkthrough, permission model, and tools integration | [Watch Video](https://www.youtube.com/watch?v=TqC1qOfiVcQ) |
| **Aider & Repository Context Engineering** | Paul Gauthier (Aider) | Repository maps using tree-sitter, git diff management, and context packing | [Watch Video](https://www.youtube.com/watch?v=JCrhyFajxYE) |
| **Model Context Protocol (MCP) Live Specification** | Anthropic | Live demonstration of MCP client/server protocol, tool discovery, and custom servers | [Watch Video](https://www.youtube.com/watch?v=PLyCki2K0Lg) |

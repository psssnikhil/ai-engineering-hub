...
| **Aider & Repository Context Engineering** | Paul Gauthier (Aider Creator) | Repository maps using tree-sitter, git diff management, and harness loops | [Watch Video](https://www.youtube.com/watch?v=JCrhyFajxYE) |
| **SWE-bench & SWE-agent Deep Dive** | Princeton NLP | Agent-computer interfaces (ACI), benchmark design, and coding agent loops | [Watch Video](https://www.youtube.com/watch?v=DrLdvbkgmeA) |

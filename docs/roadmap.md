...
Timelines shift based on contributor capacity. Check [GitHub Issues](https://github.com/psssnikhil/ai-engineering-hub/issues) for active work.
...
See the full history in [CHANGELOG](https://github.com/psssnikhil/ai-engineering-hub/blob/main/CHANGELOG.md).
...
1. **Open an issue** — request a topic, report a gap, or suggest an exercise ([issues](https://github.com/psssnikhil/ai-engineering-hub/issues))

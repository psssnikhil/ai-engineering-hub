...
|-------------------|---------------------|------------|-------------|
| **vLLM: PagedAttention & Virtual Memory Management** | Woosuk Kwon (vLLM Lead) | Architectural explanation of KV cache virtual memory management on GPUs | [Watch Video](https://www.youtube.com/watch?v=UdNocRPQS3Y) |

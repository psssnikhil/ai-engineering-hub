...
- Sequential **Learn** path — 16 numbered courses, no module codes in UI
- **140+ lessons** across foundations, build, production, and advanced
- **Agent Engineering** and **Modern AI (2026)** optional tracks
- Hub pages: Start Here, FAQ, Study Plans, Topic Map, Build These First
- GitHub Pages with link fixer for pretty URLs
- `curriculum.yml` + `npm run sync-nav` for maintainable navigation

### Fixed in v1.0.0 hardening

- Learn overview course table rendering
- Mermaid diagrams on site
- Course index metadata on all 16 courses
